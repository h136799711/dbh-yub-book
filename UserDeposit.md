...
|wallet_type|string|是|余额: balance|
...
|参数 |类型|是否必须|备注|
| ---------------- | ------------------------ | ------------------------ | ------------------------ |
|hold_fund_id|integer|是|申购基金订单id|
|amount|integer|是|转入金额 单位: 分|
...
|hold_fund_id|integer|是|申购基金订单id，传大于0则查询该笔存单明细|
...
|参数 |类型|是否必须|备注|
| ---------------- | ------------------------ | ------------------------ | ------------------------ |
|detail|int|是|1: 返回信息更多 0: 精简信息 |
|roll_out|int|是|1: 已转出 0: 未转出 |
